...
/**
 * Extended AudioThread commands to support s32 sequence IDs
 */
typedef enum {
...
// Todo, the following should go into the mod header
...
/**
 * Extended AudioSeq commands to support s32 sequence IDs
 */
typedef enum {
